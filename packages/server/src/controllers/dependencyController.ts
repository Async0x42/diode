...
export class DependencyController {
  ...
  @Get('/')
  async getList(): Promise<Dependency[]> {
    return this.service.findAll({}, { populate: columnsToPopulate });
  }

  @Get('/:id')
  async get(@PathParams('id') id: string, @Res() res: Res): Promise<Dependency | undefined> {
    try {
  ...
  create(@BodyParams() user: Dependency): Promise<Dependency> {
    return this.service.create(user);
  }

  @Put('/:id')
  async update(@PathParams('id') id: string, @Res() res: Res, @BodyParams() @Any() payload: any): Promise<Dependency | null | undefined> {
    try {
      const itemId = parseInt(id);
