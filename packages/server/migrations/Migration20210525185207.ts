...
export class Migration20210525185207 extends Migration {
  ...
  async up(): Promise<void> {
    ...
    this.addSql('create table `brd` (`id` integer not null primary key autoincrement, `title` varchar not null, `description` varchar not null, `related_requests` varchar null, `brd_number` integer null, `priority` integer null, `status` varchar null, `submission_date` datetime null, `date_entered_into_bits` datetime null, `initial_cost` integer null, `upkeep_cost` integer null);');
  }
