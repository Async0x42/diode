...
const operatingSystemNumber = useField('operatingSystemNumber');
    ...
    <form class="divide-y space-y-8 divide-gray-200 py-5 px-4 sm:px-6" @submit="onSubmit">
      <div class="divide-y space-y-8 divide-gray-200">
        <div>
          ...
          <div class="mt-6 grid gap-y-6 gap-x-4 grid-cols-1 sm:grid-cols-6">
            ...
            <FormInput label="BRD Number" :field="operatingSystemNumber" name="operatingSystemNumber" class="sm:col-span-3" />
      ...
      <div class="pt-5">
        <div class="flex justify-end">
          <button
            v-if="props.operatingSystem != null"
            type="button"
