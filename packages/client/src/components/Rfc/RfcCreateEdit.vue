  ...
  <n-form ref="formRef" :rules="rules" :model="model" class="mx-12">
    <n-grid :span="12" :x-gap="12">
      <n-form-item-gi :span="12" label="Title" path="title">
        <n-tooltip class="max-w-128" placement="bottom" trigger="hover">
          <template #trigger>
            <n-icon class="mr-2"><heroicons-solid-question-mark-circle /></n-icon>
          </template>
          <template #header>
            <n-text strong depth="1">Help</n-text>
          </template>
          ...
          <n-text tag="div" depth="3">
            <div class="space-y-2 mt-2 text-sm text-gray-500">
              ...
              <p>
                Closed:
                <br />
                The change has been implemented, verified by the Initiator, and confirmed by the Change Agent who completes the lifecycle by closing
                the RFC.
              </p>
              <p>
                Cancelled:
          ...
          <n-text tag="div" depth="3">
            <div class="space-y-2 mt-2 text-sm text-gray-500">
              ...
              <p>
                ...
                Class 2 or Class 3 based on the potential impact as defined below. During processing, the Classification of a Change may be amended to
                a more appropriate level should it be determined that the Change needs to be escalated or de-escalated.
              </p>
              <p>
                Class 1:
                <br />
                ...
                assessments must be submitted within 24 hours of the RFC being opened for Impact Assessment. Routine Class 1 impact assessments have a
                submission deadline of 10 business days.
              </p>
              <p>
                Class 2:
                <br />
              ...
              <p>
                Class 3:
                <br />
                A change that impacts the Local (delegated authority) level (Base, Wing, Formation or Units) but does not impact common or functional
                IM services or standards. This change only affects Configuration Items (CIs) that are used by a subset of users of a specific user
          ...
          <n-text tag="div" depth="3">
            <div class="space-y-2 mt-2 text-sm text-gray-500">
              ...
              <p>
                ...
                by addressing aging components or deficiencies that limit its ongoing use. Requires negligible new capability or functionality added.
              ...
              <p>
                ...
                the sustainment program: Driven by a business need to deliver an additional capability or to position an existing asset for
                ...
                operational authorities) but with clear delineation among functional and/or operational authorities as established through governance
                mechanisms.
              </p>
              <p>
      ...
      <n-form-item-gi :span="12" label="Description" path="description">
        <n-tooltip class="max-w-128" placement="bottom" trigger="hover">
          ...
          <n-text tag="div" depth="3"
            ...
            RFCs may be used if applicable</n-text
          >
        </n-tooltip>
        <n-input
      ...
      <n-form-item-gi :span="12" label="Security Implications" path="securityImplications">
        <n-tooltip class="max-w-128" placement="bottom" trigger="hover">
          ...
          <n-text tag="div" depth="3">
            ...
            completion of these deliverables (http://admim-smagi.mil.ca/en/security/policies-standards/process-dim-secur.page) which may or may not be
            required if previously submitted.</n-text
          >
        </n-tooltip>
      ...
      <n-form-item-gi :span="12" label="Affected Information Systems" path="affectedInformationSystem">
        <n-tooltip class="max-w-128" placement="bottom" trigger="hover">
          ...
          <n-text tag="div" depth="3">
            This IM CCB mandatory field is used to further identify affected information systems such as Common Email or other applications that may
            be impacted by the proposed change in addition to the Affected Infrastructure.</n-text
          >
        </n-tooltip>
        <n-input
      ...
      <n-form-item-gi :span="12" label="Concept of Operation" path="conceptOfOperation">
        <n-tooltip class="max-w-128" placement="bottom" trigger="hover">
          ...
          <n-text tag="div" depth="3">
            ...
            the latter is the best option, indicate this in the space provided. This document provides basic information regarding the operation of
            the system and often forms the basis for security recommendations. The CONOPS must include, at a minimum: a description of the system,
            including any external connections; data sensitivity information and access limitations; the user communities for specific applications
            and equipment; personnel or positions and their proposed duties or responsibilities for operations, administration, security and
            maintenance; and anticipated modification/expansion of the system.</n-text
          >
        </n-tooltip>
        <n-input
