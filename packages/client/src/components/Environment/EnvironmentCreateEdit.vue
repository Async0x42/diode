...
const { useField, onSubmit, onDelete } = useFormActions<IEnvironment>('/api/environments', 'environments', props.environment);
  ...
  <div class="bg-white shadow overflow-hidden sm:rounded-lg">
    <form class="divide-y space-y-8 divide-gray-200 py-5 px-4 sm:px-6" @submit="onSubmit">
      <div class="divide-y space-y-8 divide-gray-200">
        <div>
          <div>
            <h3 class="font-medium text-lg text-gray-900 leading-6">Environment Information</h3>
            <p class="mt-1 text-sm text-gray-500">Environment details and notes.</p>
          </div>
      ...
      <div class="pt-5">
        <div class="flex justify-end">
          <FormButtonDelete v-if="props.environment" class="mr-3 inline-flex justify-center" @click="onDelete()" />
