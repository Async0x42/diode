import { DocumentTextIcon, ClockIcon, HomeIcon, PhoneIcon, CalendarIcon, GlobeAltIcon, CodeIcon, CircuitIcon } from '@heroicons/vue/outline';
import { ref } from 'vue';
...
export const navigation = ref([
  ...
  { name: 'Servers', to: { name: 'servers' }, icon: CircuitIcon },
]);
